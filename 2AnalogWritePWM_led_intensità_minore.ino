...
nella sezione loop invece richiamiamo la funzione analogWrite e nella parentesi specifichiamo il punto dove attacheremo l'anodo(+) e il secondo numero è arbitrario da 0 a 255 e definisce l'intensità voluta dove 0 è minor intensità e 255 è il massimo dell'intensità
*/
void setup() {
}
